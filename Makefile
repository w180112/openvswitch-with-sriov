...
DIST_COMMON = $(srcdir)/manpages.mk \
	...
	$(openvswitchinclude_HEADERS) $(ovninclude_HEADERS) COPYING \
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/sat-math.h lib/seq.c lib/seq.h lib/sfc_send.c lib/sha1.c \
	lib/sha1.h lib/shash.c lib/simap.c lib/simap.h lib/smap.c \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/seq.lo lib/sfc_send.lo lib/sha1.lo lib/shash.lo \
...
ACLOCAL = ${SHELL} /root/openvswitch-2.7.2/build-aux/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /root/openvswitch-2.7.2/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/openvswitch-2.7.2/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /root/openvswitch-2.7.2/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /root/openvswitch-2.7.2/build-aux/missing automake-1.13
AWK = gawk
CAPNG_LDADD = 
...
KARCH = 
KBUILD = /lib/modules/3.10.0-514.el7.x86_64/build
...
LT_CURRENT = 1
LT_REVISION = 0
MAKEINFO = ${SHELL} /root/openvswitch-2.7.2/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
PYTHON3 = ${SHELL} /root/openvswitch-2.7.2/build-aux/missing python3
RANLIB = ranlib
...
VERSION = 2.7.2
VSTUDIO_CONFIG = 
WARNING_FLAGS =  -Wall -Wextra -Wno-sign-compare -Wpointer-arith -Wformat -Wformat-security -Wswitch-enum -Wunused-parameter -Wbad-function-cast -Wcast-align -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-field-initializers -fno-strict-aliasing
abs_builddir = /root/openvswitch-2.7.2
abs_srcdir = /root/openvswitch-2.7.2
abs_top_builddir = /root/openvswitch-2.7.2
abs_top_srcdir = /root/openvswitch-2.7.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/openvswitch-2.7.2/build-aux/install-sh
...
lib/sfc_send.lo: lib/$(am__dirstamp) lib/$(DEPDIR)/$(am__dirstamp)
...
include lib/$(DEPDIR)/sfc_send.Plo
